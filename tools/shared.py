...
class Building(object):
  ...
  def is_wasm_only():
    ...
    # compatible with it.
    return ('asmjs' not in Settings.BINARYEN_METHOD and 'interpret-asm2wasm' not in Settings.BINARYEN_METHOD and not Settings.RUNNING_JS_OPTS) or not Settings.LEGALIZE_JS_FFI
